...
def echo(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    app.send_message(message.chat.id, '**Hi, I am Mdisk Video Downloader, you can watch Videos without MX Player.\n__Send me a mdisk link to convert...__\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ @nickallbots**',reply_to_message_id=message.id,
    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🤴 Owner 🤴", url="https://t.me/mdiskbot200")], [InlineKeyboardButton("🛸 Updates Channel 🛸", url="https://t.me/nickallbots")], [InlineKeyboardButton("🍿 Movie lover 🍿", url="https://t.me/allmoviesheretojoinhindi")]]))
...
**/show** - show Thumbnail
**/mode** - change upload mode ( default mode is Document )__"""
